<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Profile.aspx.cs" Inherits="AirBros.Profile" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <style type="text/css">
            ...
            .tablestyle {
                ...
                text-align: center;
                position: relative;
                background-image: linear-gradient(180deg,rgba(132, 220, 255, 0.5),rgba(168, 255, 252, 0.5));
            }
            .hed {
                height: 60px;
    ...
    <asp:Panel ID="profilee" runat="server">
        <div id ="Div1" runat="server">
            <table id="tab" class="tables">
                <tr>
                    <td class="hed" colspan="2">
                        <asp:Label ID="Labe1" runat="server" ForeColor="DodgerBlue" Font-Size="XX-Large" Text="Profile Controls"></asp:Label>
                        <br />
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="2" class="buttn">
                        <asp:button id="Butto34" runat="server" CssClass="btn" text="Exit" causesvalidation="false" OnClick="Butto34_Click" />
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="buttn">
                        <asp:Button ID="vue" runat="server" CssClass="btn" Text="View" OnClick="vue_Click" />
                    </td>
                </tr>
                <tr>
                    <td class="buttn">
                        <asp:Button ID="Btn1" runat="server" CssClass="btn" Text="Update" OnClick="Btn1_Click" />
                    </td>
                </tr>
            </table>
        </div>
    ...
    <asp:Panel runat="server" ID="upd" Visible="false">
        
        <table class="tablestyle">
            <tr>
                <td class="hed">
                    <asp:Label ID="Label1" runat="server" ForeColor="#ffffff" Font-Size="XX-Large" Text="USER PROFILE"></asp:Label>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                <td class="table-data">
                    ...
                    <asp:TextBox ID="DOB_TB" CssClass="boxes" runat="server" placeholder="dd-mmm-yyyy" ForeColor="white"></asp:TextBox>
            ...
            <tr>
                <td class="table-data">
                    ...
                    <asp:TextBox ID="Phone_TB" ForeColor="white" runat="server" CssClass="boxes" placeholder="Enter your 10 digit Mobile Number"></asp:TextBox>
     ...
     <!--       <tr>
            ...
            <tr>
                <td class="table-data">
                    ...
                    <asp:TextBox ID="Email_TB" ForeColor="white" CssClass="boxes" placeholder="Enter your E-Mail" runat="server"></asp:TextBox>
            ...
            <tr>
                <td class="table-data">
                    ...
                    <asp:TextBox ID="Password_TB" ForeColor="white" CssClass="boxes" placeholder="Password" runat="server"></asp:TextBox>
